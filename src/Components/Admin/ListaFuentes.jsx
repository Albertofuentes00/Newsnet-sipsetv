                ...
                {Datos.map((Datos, i) => (
                  <tr key={Datos.pkFuente}>
                    ...
                    <td>
                      <button
                        onClick={() =>
                          OpenModal(2, Datos.pkFuente, Datos.nombre_Fuente)
                        }
                        className="acciones"
                        data-bs-toggle="modal"
                        data-bs-target="#modaldefault"
                      ...
                      <button
                        onClick={() =>
                          deleteDatos(Datos.pkFuente, Datos.nombre_Fuente)
                        }
                        className="acciones"
                      >
                        {' '}
          ...
          <div className="modal-content">
            ...
            <div className="modal-body">
              <h2 className="Text-helper">
                Ingresa los datos requeridos para registrar una fuente nueva en
                el sistema
              </h2>
              ...
              <div className="input-group mb-3">
                ...
                <input
                  ...
                  placeholder="Fuente"
                  value={nombre_Fuente}
                  onChange={(e) => setNombre_Fuente(e.target.value)}
                ></input>
              </div>
            </div>
      ...
      <div id="notasrela" className="modal fade" aria-hidden="false">
        <div className="modal-dialog">
          <div className="modal-content">
            <div className="modal-header">
              <label className="h5">
                La fuente no se puede borrar, esta relacionada con los siguiente
                elementos
              </label>
            </div>
            <div className="modal-body">
