...
const ListaProgramas = () => {
  ...
  const Validar = () => {
    ...
    if (fkCategoria === '') {
      ...
      if (operation === 1) {
        parametros = {
          nombre_Programa: nombre_Programa.trim(),
                ...
                {currentData.map((Datos, i) => (
                  <tr key={Datos.pkPrograma}>
                    ...
                    <td>
                      ...
                      <button
                        onClick={() =>
                          deleteDatos(Datos.pkPrograma, Datos.nombre_Programa)
                        }
                        className="acciones"
                      >
                        <FaTrash size={20} />
          ...
          <div className="modal-content">
            ...
            <div className="modal-body">
              <h2 className="Text-helper">
                Ingresa los datos requeridos para registrar un programa nuevo en
                el sistema
              </h2>
