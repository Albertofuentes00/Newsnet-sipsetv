                ...
                {currentData.map((Datos, i) => (
                  <tr key={Datos.pkFormato}>
                    ...
                    <td>
                      <button
                        onClick={() =>
                          OpenModal(2, Datos.pkFormato, Datos.nombre_Formato)
                        }
                        className="acciones"
                        data-bs-toggle="modal"
                        data-bs-target="#modaldefault"
                      ...
                      <button
                        onClick={() =>
                          deleteDatos(Datos.pkFormato, Datos.nombre_Formato)
                        }
                        className="acciones"
                      >
                        {' '}
          ...
          <div className="modal-content">
            ...
            <div className="modal-body">
              <h2 className="Text-helper">
                Ingresa los datos requeridos para registrar un formato nuevo en
                el sistema
              </h2>
              ...
              <div className="input-group mb-3">
                ...
                <input
                  ...
                  placeholder="Formato"
                  value={nombre_Formato}
                  onChange={(e) => setNombre_Formato(e.target.value)}
                ></input>
              </div>
            </div>
