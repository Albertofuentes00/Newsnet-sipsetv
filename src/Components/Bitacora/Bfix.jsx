...
//   }
//   const OpenModal = (op,pkNota,titulo,conductor,fkCategoria,fkFormato,fkUsuario,fecha) =>{
//     setPkNota('');
//     setTitulo('');
//     setConductor('');
//     setTipo('');
...
//           const user = partes[0];
//           conductor = "JB"
//           console.log(titulo,fechaFormateada.toString(),conductor,tipo,indice,fkFormato,fkUsuario,fkCategoria,fkfuente);
//           parametros = {titulo:titulo.trim(),fecha:fechaFormateada,conductor:conductor,tipo:0,indice:0,fkFormato:fkFormato,fkfuente:fkfuente.trim(),fkUsuario:user,fkCategoria:fkCategoria};
//           axios.post('https://localhost:7201/Nota/Post', parametros).then(function(respuesta){
//           console.log("se envio "+ respuesta.data.result);
//           document.getElementById('btnCerrar').click();
//           GetDatos();
//         })
//         .catch(function(error){
//           show_alerta('Error en la solicitud','error');
//           console.log(titulo,fechaFormateada,conductor,tipo,indice,fkFormato,fkUsuario,fkCategoria,fkfuente);
//           console.log(error);
//         });
//         } catch (error) {
//           console.log(error);
...
//       }
//       else{
//         parametros = {titulo:titulo.trim(),fkCategoria:fkCategoria,idFormato:fkFormato.trim(),fuente:fkfuente.trim(),fkUsuario:fkUsuario,fecha:fecha};
